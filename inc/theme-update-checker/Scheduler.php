<?php
if ( !class_exists('Wrt_Tuc_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Wrt_Tuc_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Wrt_Tuc_Scheduler {
		 ...
		 *
		 * @param Wrt_Tuc_UpdateChecker $updateChecker
		...
		public function upgraderProcessComplete(
			...
			if ( is_a($this->updateChecker, 'Wrt_Tuc_Theme_UpdateChecker') ) {
			...
			if ( is_a($this->updateChecker, 'Wrt_Tuc_Plugin_UpdateChecker') ) {
		 ...
		 *
		 * You can override the default behaviour by using the "wrt_tuc_check_now-$slug" filter.
