...
if ( !class_exists('Wrt_Tuc_Theme_UpdateChecker', false) ):

	class Wrt_Tuc_Theme_UpdateChecker extends Wrt_Tuc_UpdateChecker {
		 ...
		 *
		 * @return Wrt_Tuc_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('Wrt_Tuc_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var Wrt_Tuc_Theme_Update $themeUpdate */
		...
		protected function createInstalledPackage() {
			return new Wrt_Tuc_Theme_Package($this->stylesheet, $this);
		}
	}
