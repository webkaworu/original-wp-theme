...
if ( !class_exists('Wrt_Tuc_Theme_Update', false) ):

	class Wrt_Tuc_Theme_Update extends Wrt_Tuc_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|Wrt_Tuc_Theme_Update $object The source object.
		 * @return Wrt_Tuc_Theme_Update The new copy.
		 */
