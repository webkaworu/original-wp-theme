<?php
if ( !class_exists('Wrt_Tuc_DebugBar_Extension', false) ):

	class Wrt_Tuc_DebugBar_Extension {
		const RESPONSE_BODY_LENGTH_LIMIT = 4000;

		/** @var Wrt_Tuc_UpdateChecker */
		protected $updateChecker;
		protected $panelClass = 'Wrt_Tuc_DebugBar_Panel';
		...
		public function __construct($updateChecker, $panelClass = null) {
			...
			add_action('wp_ajax_wrt_tuc_debug_check_now', array($this, 'ajaxCheckNow'));
		}
		...
		public function removeHooks() {
			...
			remove_action('wp_ajax_wrt_tuc_debug_check_now', array($this, 'ajaxCheckNow'));
		}
